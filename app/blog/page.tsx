...
export const metadata: Metadata = {
  ...
  description: "Teknoloji dünyasındaki son gelişmeler, yazılım geliştirme ipuçları, siber güvenlik trendleri ve bilgisayar tamiri rehberleri. Uzman görüşleri ve pratik bilgiler.",
  keywords: "blog, teknoloji, yazılım geliştirme, siber güvenlik, bilgisayar tamiri, yapay zeka, veri analizi, web geliştirme",
  openGraph: {
    title: "Blog - Bayraktar Yazılım 3D",  
    description: "Teknoloji dünyasındaki son gelişmeler, uzman görüşleri ve pratik rehberler.",
    url: "/blog",
  },
  alternates: {
    canonical: "/blog",
...
export default function BlogPage() {
  ...
  const structuredData = {
    ...
    "@type": "Blog",
    "name": "Bayraktar Yazılım 3D Blog",
    "description": "Teknoloji dünyasındaki son gelişmeler, yazılım geliştirme ipuçları ve uzman görüşleri",
    ...
    "blogPost": blogPosts.map(post => ({
      ...
      "url": `${process.env.NEXT_PUBLIC_SITE_URL || "https://example.com"}/blog/${post.id}`,
