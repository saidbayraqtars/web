  ...
  const contactMethods = [
    {
      ...
      action: () => window.open('tel:+905001234567', '_self'),
      color: 'blue'
    },
    {
      id: 2,
      ...
      action: () => window.open('https://wa.me/905001234567', '_blank'),
      color: 'green'
    },
    {
      id: 3,
      title: 'E-posta',
      icon: 'ri-mail-fill',
      value: 'info@bayraktaryazilim.com',
      description: 'Detaylı projeler için',
      action: () => window.open('mailto:info@bayraktaryazilim.com', '_self'),
      color: 'purple'
    },
    {
      id: 4,
      ...
      value: 'Teknoloji Mahallesi, İnovasyon Caddesi',
      description: 'No:123, İstanbul',
        ...
        <div className="max-w-2xl">
          ...
          <div className="bg-gradient-to-br from-green-50 to-green-100 rounded-2xl p-6">
            ...
            <p className="text-gray-700 mb-2">
              Bilgisayar tamiri ve teknik destek hizmetlerimiz için İstanbul'da fiziksel ofisimiz bulunmaktadır.
            </p>
